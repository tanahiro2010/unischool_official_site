        ...
        <div className="max-w-4xl mx-auto px-4 py-12 text-neutral-800">
            ...
            <section className="mb-10">
                ...
                <p className="leading-relaxed">
                    本ポリシーは、当チームが本サービスを通じて取得する個人情報の取扱いについて、Google
                    Cloud の OAuth API スコープ審査に
            ...
            <section className="mb-10">
                ...
                <h3 className="text-lg font-medium mt-6 mb-3">
                    2.1 Google アカウントによる認証情報
                </h3>
                <p className="leading-relaxed mb-4">
                    本サービスの一部機能では、Google Login（OAuth
                    2.0）を使用した認証を提供しています。 ユーザーが Google
                    アカウントでログインする際に、以下の情報を取得します。
                </p>
                <ul className="list-disc pl-6 leading-relaxed mb-4 space-y-2">
                    <li>Google アカウントのメールアドレス</li>
                    <li>
                        Google
                        アカウントのプロフィール情報（氏名、アバター画像）
                    </li>
                    <li>Google アカウントの一意の識別子（sub）</li>
                </ul>
                <p className="leading-relaxed mb-4">
                    一部の機能では、ユーザーの明示的な同意に基づき、Google Cloud
                    の審査が必要な スコープ（例: 特定の Google
                    サービスへのアクセス権限）を要求する場合があります。
                    これらのスコープは、各機能の提供に必要最小限の範囲に限定して利用し、
                    ユーザーの同意なく追加のスコープを要求することはありません。
                </p>
                <p className="leading-relaxed">
                    <strong>利用目的:</strong>{" "}
                    ユーザー認証、アカウント管理、本人確認、及び本サービスの
                    機能提供のため。
                </p>
                ...
                <p className="leading-relaxed mb-4">
                    当チームのウェブサイトでは、Google Analytics
                    を利用してアクセス解析を行っています。 Google Analytics
                    は、クッキー（Cookie）を使用して以下の情報を収集します。
                </p>
                <ul className="list-disc pl-6 leading-relaxed mb-4 space-y-2">
                    ...
                    <li>オペレーティングシステム</li>
                    <li>
                        おおよその地理的位置（IPアドレスから特定できない範囲）
                    </li>
                    <li>デバイス情報</li>
                </ul>
                <p className="leading-relaxed">
                    <strong>利用目的:</strong>{" "}
                    ウェブサイトの利用状況分析、品質向上、及びコンテンツ改善のため。
                    Google Analytics で収集されたデータは、Google
                    社のプライバシーポリシーに従って管理されます。
                </p>
            </section>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 leading-relaxed">
                    <p>
                        <strong>アクセス制限:</strong>{" "}
                        当チームが取得した個人データは、限られた管理陣のみが
                        アクセスできる厳格な環境で管理されます。管理権限を持つ者の一覧は定期的に見直され、
                        不要になった権限は速やかに剥奪されます。
                    </p>
                    <p>
                        <strong>パスワードの保護:</strong>{" "}
                        本サービスで使用するパスワードは、最新の暗号化アルゴリズム
                        （bcrypt
                        等のハッシュ関数）を用いて厳重に暗号化（ハッシュ化）された状態で保存されます。
                        パスワードそのものを平文で保存することはなく、いかなる状況においても復元できない形で管理します。
                    </p>
                    <p>
                        <strong>データの仮名化・匿名化:</strong>{" "}
                        保存するデータは、個人を特定できないよう
            ...
            <section className="mb-10">
                <h2 className="text-xl font-semibold mb-4">
                    6. Google OAuth API スコープの使用について
                </h2>
                <p className="leading-relaxed mb-4">
                    本サービスが Google OAuth 2.0
                    を介して取得する各スコープは、以下の限定された目的にのみ使用されます。
                </p>
                <ul className="list-disc pl-6 leading-relaxed space-y-2">
                    <li>取得した情報は、明示された目的以外に使用しません。</li>
                    <li>
                        ユーザーデータを広告目的に使用することはありません。
                    </li>
                    <li>ユーザーデータを第三者に販売することはありません。</li>
                    <li>
                        ユーザーがアカウントを削除した場合、関連するデータは速やかに削除されます。
                    </li>
                    <li>
                        Google API から取得した情報の使用は、
                        <a
