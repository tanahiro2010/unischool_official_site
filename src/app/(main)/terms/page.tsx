        ...
        <div className="max-w-4xl mx-auto px-4 py-12 text-neutral-800">
            ...
            <section className="mb-10">
                ...
                <p className="leading-relaxed">
                    本規約（以下「本規約」）は、UniSchool（以下「当チーム」）が提供するウェブサイト、
                    及び開発するソフトウェア（以下「本サービス」）の利用条件を定めるものです。
            ...
            <section className="mb-10">
                <h2 className="text-xl font-semibold mb-4">3. 規約への同意</h2>
                <p className="leading-relaxed">
                    ユーザーは、本サービスを利用することにより、本規約に同意したものとみなされます。
                    本規約に同意いただけない場合、本サービスをご利用いただけません。
                    本サービスを実際に利用する前に、本規約をよくお読みください。
                </p>
            </section>
            ...
            <section className="mb-10">
                <h2 className="text-xl font-semibold mb-4">5. 禁止行為</h2>
            ...
            <section className="mb-10">
                <h2 className="text-xl font-semibold mb-4">6. 知的財産権</h2>
                <p className="leading-relaxed">
                    本サービスに含まれる全てのコンテンツに関する著作権、商標権その他の知的財産権は、
                    当チームまたは正当な権利者に帰属します。ユーザーは、当チームの明示的な許可なく、
                    これらのコンテンツを転載、複製、改変、配布することはできません。
                </p>
            </section>
            ...
            <section className="mb-10">
                <h2 className="text-xl font-semibold mb-4">8. 秘密保持</h2>
                <p className="leading-relaxed">
                    ユーザーは、本サービスの利用を通じて知り得た当チームの技術上、営業上その他の
                    秘密情報を、当チームの事前の書面による同意なく第三者に開示または漏洩してはなりません。
                </p>
            </section>
            ...
            <section className="mb-10">
                ...
                <p className="leading-relaxed mt-4">
                    ...
                    適用されます。当チームは、外部サービスの利用により生じたいかなる損害についても責任を負いません。
                </p>
            </section>

            <section className="mb-10">
                <h2 className="text-xl font-semibold mb-4">11. 規約の変更</h2>
                <p className="leading-relaxed">
                    当チームは、必要と判断した場合、予告なく本規約を変更することができます。
                    変更後の規約は、本サービス上に掲載された時点で効力を生じるものとします。
                    ユーザーは、定期的に本規約を確認するものとし、変更後に本サービスを継続して利用した場合、
                    変更に同意したものとみなされます。
                </p>
            </section>
